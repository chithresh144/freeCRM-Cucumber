...
export class LoginFreeCRMPage {
  ...
  async navigate() {
    await this.page.goto('https://www.freecrm.com/');
  ...
  async login() {
    ...
    await newTab.getByPlaceholder("Email").fill("chithresh.vemu.cse@gmail.com")
    await newTab.getByPlaceholder("Password").fill("Chinnu@144")
